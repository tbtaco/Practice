...
[LeetCode0058.cs](https://github.com/tbtaco/Practice/blob/master/Practice/LeetCode0058.cs) - Easy - Solved - Length of Last Word - Given a string s consisting of words and spaces, return the length of the last word in the string.
<!-- Other info on LeetCode0058.cs - Author: Tyler Richey - Date: 7/5/2023 - Time Complexity: O(n) -->
...
[LeetCode0080.cs](https://github.com/tbtaco/Practice/blob/master/Practice/LeetCode0080.cs) - Medium - Solved - Remove Duplicates from Sorted Array II - Given an integer array nums sorted in non-decreasing order, remove some duplicates in-place such that each unique element appears at most twice. The relative order of the elements should be kept the same.
<!-- Other info on LeetCode0080.cs - Author: Tyler Richey - Date: 7/9/2023 - Time Complexity: O(n) -->
...
[LeetCode0112.cs](https://github.com/tbtaco/Practice/blob/master/Practice/LeetCode0112.cs) - Easy - Solved - Path Sum - Given the root of a binary tree and an integer targetSum, return true if the tree has a root-to-leaf path such that adding up all the values along the path equals targetSum.
<!-- Other info on LeetCode0112.cs - Author: Tyler Richey - Date: 8/8/2023 - Time Complexity: O(n) -->
...
[LeetCode0119.cs](https://github.com/tbtaco/Practice/blob/master/Practice/LeetCode0119.cs) - Easy - Solved - Pascal's Triangle II - Given an integer rowIndex, return the rowIndexth (0-indexed) row of the Pascal's triangle.
<!-- Other info on LeetCode0119.cs - Author: Tyler Richey - Date: 7/7/2023 - Time Complexity: O(n^2) - Notes: I started with my solution to LeetCode 118 and modified to give just the last row.  I could then delete older rows that are no longer needed to minimize memory usage further. -->

[LeetCode0120.cs](https://github.com/tbtaco/Practice/blob/master/Practice/LeetCode0120.cs) - Medium - Solved - Triangle - Given a triangle array, return the minimum path sum from top to bottom.
<!-- Other info on LeetCode0120.cs - Author: Tyler Richey - Date: 10/5/2013 - Time Complexity: O(n) -->
